...
class Bridge(ABC):
    ...
    def _weight_name_mapping_attention(self, name: str) -> list[str]:
        ...
        _ATTENTION_MAPPING = {
            ...
            'self_attention.linear_q_proj.weight': ['model.layers.{layer_number}.self_attn.q_proj.weight'],
            'self_attention.linear_kv_down_proj.weight': ['model.layers.{layer_number}.self_attn.kv_a_proj_with_mqa.weight'],
            # 'self_attention.linear_kv_up_proj.layer_norm_weight': ['model.layers.{layer_number}.self_attn.kv_a_layernorm.weight'],
            'self_attention.linear_kv_up_proj.weight': ['model.layers.{layer_number}.self_attn.kv_b_proj.weight'],
            'self_attention.linear_q_down_proj.weight': ['model.layers.{layer_number}.self_attn.q_a_proj.weight'],
            'self_attention.linear_q_up_proj.weight': ['model.layers.{layer_number}.self_attn.q_b_proj.weight'],
            # 'self_attention.linear_q_up_proj.layer_norm_weight': ['model.layers.{layer_number}.self_attn.q_a_layernorm.weight'],
