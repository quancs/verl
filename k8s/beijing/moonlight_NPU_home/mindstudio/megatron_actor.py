...
class MegatronPPOActor(BasePPOActor):
    ...
    def update_policy(self, dataloader: Iterable[DataProto]) -> dict:
        ...
        if os.environ['JOB_LOG_DIR_CURR']:
            ...
            dump_path="/data/logs/msprobe_dump_output_1"

        from msprobe.pytorch import PrecisionDebugger
        debugger = PrecisionDebugger(dump_path=dump_path, config_path="/home/code/verl-gpu/k8s/beijing/moonlight_NPU_home/msprobe.json", level="L0")
        ...
        for data in dataloader:
            ...
            debugger.start(model=self.actor_module)
