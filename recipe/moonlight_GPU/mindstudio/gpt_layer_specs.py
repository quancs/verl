...
from megatron.core.transformer.dot_product_attention import MyDotProductAttention
from megatron.core.transformer.torch_norm import WrappedTorchNorm
...
def get_gpt_layer_with_transformer_engine_spec(
    ...
    if multi_latent_attention:
        ...
        if normalization == "RMSNorm":
            ...
            qk_norm_mla = backend.layer_norm(rms_norm=True, for_qk=True)
        else:
            # layer_norm = backend.layer_norm(rms_norm=False, for_qk=False)
            qk_norm_mla = backend.layer_norm(rms_norm=False, for_qk=True)
            ...
            submodules=TransformerLayerSubmodules(
                ...
                self_attention=ModuleSpec(
                    ...
                    submodules=MLASelfAttentionSubmodules(
                        ...
                        # q_layernorm=qk_norm_mla if qk_layernorm else IdentityOp,
                        # kv_layernorm=qk_norm_mla if qk_layernorm else IdentityOp,
